...
<div class="row my-4">
    <div class="col-lg-8 mx-auto">
        <div class="card shadow">
            <img src="{{ asset('storage/images/'.$post->image)}}" alt="" class="img-fluid card-img-top">
            <div class="card-body p-5">
                ...
                <div class="card-footer px-5 py-3 d-flex justify-content-end">
                    ...
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-danger rounded-pill" onclick="return confirm(&quot;Are You Sure You Want To Delete?&quot;)">Delete</button>
                </form>
                </div>
            </div>
        </div>
