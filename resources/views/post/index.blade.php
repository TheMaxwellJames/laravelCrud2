...
{{-- <div class="alert alert-{{ session('status') }} alert-dismissible fade show " role="alert">
    ...
    <button type="button" class="btn-close" alert-bs-dismiss="alert" aria-label="Close"></button>
</div> --}}
...
<div class="row g-4 mt-1">
    ...
    <div class="col-lg-4">
        <div class="card shadow">
            <a href="post/{{ $row->id }}">
            <img src="{{ asset('storage/images/'.$row->image) }}" class="card-img-top img-fluid" alt="">
            </a>
            <div class="card-body">
